...
//           for class TSipPrack
/////////////////////////////////////////////
PTMsgBody TSipPrack::clone()
{
	PTSipPrack amsg = new TSipPrack();
	amsg->req_uri                   = req_uri;
	amsg->content_type              = content_type;
	amsg->body                      = body;
	return amsg;
}
TSipPrack& TSipPrack::operator=(const TSipPrack &r)
{
	req_uri                   = r.req_uri;
	content_type              = r.content_type;
	body                      = r.body;
...
BOOL TSipPrack::operator == (TMsgPara& msg)
{
	COMPARE_MSG_BEGIN(TSipPrack,msg)

	COMPARE_FORCE_NEST(TSipPrack,TSipURI,req_uri)
	COMPARE_FORCE_NEST(TSipPrack,TSipContentType,content_type)
	COMPARE_FORCE_NEST(TSipPrack,TSipBody,body)
...
BOOL TSipPrack::decodeFromXML(TiXmlHandle& xmlParser,PCGFSM fsm)
{
	FILL_FIELD_BEGIN

	FILL_FORCE_NEST(TSipPrack,TSipURI,req_uri)
	FILL_FORCE_NEST(TSipPrack,TSipContentType,content_type)
	FILL_FORCE_NEST(TSipPrack,TSipBody,body)

	FILL_FIELD_END
}

void TSipPrack::print(ostrstream& st)
{
	st<<"==| TSipPrack =="<<endl;
	st<<"$req_uri : ";
	req_uri.print(st);
...
{
	PTSipUpdate amsg = new TSipUpdate();
	amsg->req_uri                   = req_uri;
	amsg->content_type              = content_type;
	amsg->body                      = body;
	return amsg;
